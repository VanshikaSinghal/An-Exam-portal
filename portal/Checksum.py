# pip install pycryptodome only
# encode aes with .encode('utf-8')
import base64
import string
import random
import hashlib
...
def __encode__(to_encode, iv, key):
    ...
    # Encrypt
    c = AES.new(key.encode('utf-8'), AES.MODE_CBC, iv.encode('utf-8')) # change
    to_encode = c.encrypt(to_encode.encode('utf-8')) # change
    # Encode
